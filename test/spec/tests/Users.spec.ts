...
describe('Users Routes', () => {
    ...
    describe(`"POST:${addUsersPath}"`, () => {
        ...
        it(`should return a status code of "${CREATED}" if the request was successful.`, (done) => {
            // Setup Spy
            spyOn(UserService.prototype, 'add').and.returnValue(Promise.resolve());
            // Call API
    ...
    describe(`"PUT:${updateUserPath}"`, () => {
        ...
        it(`should return a status code of "${OK}" if the request was successful.`, (done) => {
            // Setup spy
            spyOn(UserService.prototype, 'update').and.returnValue(Promise.resolve());
            // Call Api
            callApi(userData)
                .end((err: Error, res: IResponse) => {
                    pErr(err);
    ...
    describe(`"DELETE:${deleteUserPath}"`, () => {
        ...
        it(`should return a status code of "${OK}" if the request was successful.`, (done) => {
            // Setup spy
            spyOn(UserService.prototype, 'delete').and.returnValue(Promise.resolve());
            // Call api
            callApi(5)
                .end((err: Error, res: IResponse) => {
                    pErr(err);
